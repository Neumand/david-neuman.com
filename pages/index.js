...
const Home = ({ featuredPosts }) => {
  ...
  return (
    <Layout>
      <section className="hero flex flex-col justify-evenly items-center mb-8 w-full md:flex-row">
