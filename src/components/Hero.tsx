...
export const Hero = () => {
  return (
    <div className='flex flex-col p-8 gap-8 h-[25rem] w-full dark:bg-zinc-900 bg-gray-200/75  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative items-center justify-center'>
