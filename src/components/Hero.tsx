...
export const Hero = () => {
  return (
    <div className='flex flex-col p-8 gap-6 h-[25rem] w-full relative items-center justify-center skeuo-hero'>
      <div className='absolute pointer-events-none inset-0 flex items-center justify-center bg-dot-black/[0.08] dark:bg-dot-white/[0.08] [mask-image:radial-gradient(ellipse_at_center,transparent_70%,black)]'></div>
      <motion.img
        className='rounded-full inline-block h-32 w-32 border-4 border-[hsl(var(--paper))] shadow-xl'
      ...
      <motion.h1
        ...
        className='text-[hsl(var(--ink-strong))] dark:text-[hsl(var(--foreground))] text-4xl sm:text-7xl font-bold relative'
      >
        Hi, I'm David
      </motion.h1>
      ...
      <motion.div
        ...
        className='flex flex-col gap-2 text-md md:text-lg max-w-lg text-center text-[hsl(var(--ink-soft))]'
      >
        <p className='flex flex-col md:inline'>
          I'm a product-minded engineer learning{' '}
          <span className='border border-[hsl(var(--border))] border-solid px-4 py-2 relative self-center rounded-full skeuo-pill'>
            <span>design.</span>
            <div className='absolute top-[-4px] -left-[4px] p-0 bg-[hsl(var(--ember))] w-2 aspect-square rounded-full ' />
            <div className='absolute bottom-[-4px] -left-[4px] p-0 bg-[hsl(var(--ember))] w-2 aspect-square rounded-full ' />
            <div className='absolute top-[-4px] -right-[4px] p-0 bg-[hsl(var(--ember))] w-2 aspect-square rounded-full ' />
            <div className='absolute bottom-[-4px] -right-[4px] p-0 bg-[hsl(var(--ember))] w-2 aspect-square rounded-full ' />
          </span>
        </p>
